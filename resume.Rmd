...
tribble(
  ~Type, ~Desc,
  "Programming", "I am an expert in R and Python programming and package development. I also have experience in C++, JavaScript, PHP, C#, HTML, CSS, Java, Groovy, Nextflow, Snakemake, and BASH scripting.", 
  ...
  "Reproducible research", "I can create fully scripted, self-contained, and version-controlled analysis workflows that generate HTML/PDF output containing all descriptions, code, and publication-ready graphics.", 
